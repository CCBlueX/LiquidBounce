...
class GuiModsMenu(private val prevGui: GuiScreen) : GuiScreen() {
    ...
    override fun initGui() {
        ...
        val state = LiquidBounce.clientRichPresence.showRichPresenceValue
        buttonList.add(GuiButton(2, width / 2 - 100, height / 4 + 48 + 50, "Rich Presence: ${if (state) "§aON" else "§cOFF"}"))
