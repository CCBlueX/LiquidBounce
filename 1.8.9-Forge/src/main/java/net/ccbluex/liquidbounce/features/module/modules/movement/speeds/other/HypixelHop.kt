    ...
    override fun onMotion() {
        if (MovementUtils.isMoving()) {
            if (mc.thePlayer!!.onGround) {
                ...
                if (mc.thePlayer!!.onGround && mc.thePlayer!!.isPotionActive(Potion.moveSpeed)) speed *= 1f + 0.13f * (1 + mc.thePlayer.getActivePotionEffect(Potion.moveSpeed).getAmplifier())
