...
class MineplexGround : SpeedMode("MineplexGround") {
    ...
    override fun onMotion() {
        ...
        spoofSlot = false
        for (i in 36..44) {
            val itemStack: ItemStack = mc.thePlayer!!.inventoryContainer.getSlot(i).getStack()
    ...
    override fun onUpdate() {
        ...
        val blockPos = BlockPos(mc.thePlayer!!.posX, mc.thePlayer.getEntityBoundingBox().minY - 1, mc.thePlayer!!.posZ)
        val vec: Vec3 = Vec3(blockPos).addVector(0.4f, 0.4f, 0.4f).add(Vec3(EnumFacing.UP.getDirectionVec()))
