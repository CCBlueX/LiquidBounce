...
class SPacketPosLookImpl<out T : S08PacketPlayerPosLook>(wrapped: T) : PacketImpl<T>(wrapped), ISPacketPosLook
{
...
fun S08PacketPlayerPosLook.wrap(): ISPacketPosLook = SPacketPosLookImpl(this)
