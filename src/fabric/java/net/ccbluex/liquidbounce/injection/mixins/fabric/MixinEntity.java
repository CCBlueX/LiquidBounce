 ...
 * <p>
 * NeoForge patches the body of {@code restituteMovementAfterCollisions} into an
 * added overload with a leading {@code BlockPos} parameter, so each loader hooks
 * its own shape of the {@code Math#max} slime-bounce expression.
 */
@Mixin(Entity.class)
