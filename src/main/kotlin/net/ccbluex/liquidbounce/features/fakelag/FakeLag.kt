...
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.verus.FlyVerusFlat
...
object FakeLag : Listenable {
    ...
    private fun shouldLag(packet: Packet<*>?): LagResult? {
        ...
        if (ModuleBlink.enabled || ModuleAntiVoid.needsArtificialLag || ModuleFakeLag.shouldLag(packet)
            ...
            || ScaffoldBlinkFeature.shouldBlink || FlyVerusFlat.requiresLag) {
