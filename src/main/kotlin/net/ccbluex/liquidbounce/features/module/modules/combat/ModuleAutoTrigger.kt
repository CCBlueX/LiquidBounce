...
object ModuleAutoTrigger : ClientModule(
    ...
    private val tickHandler = tickHandler {
        ...
        val cooldownProgress = player.attackStrengthTicker
                .toFloat() / player.currentItemAttackStrengthDelay
        ...
        val canDirectTrigger = hasValidTarget &&
            consecutiveTargetTicks >=
                precisionTicks

        val cooldownRemainingTicks =
            player.currentItemAttackStrengthDelay - player.attackStrengthTicker

        val inPostTriggerWindow = cooldownRemainingTicks >= 0 &&
                cooldownRemainingTicks <=
                PostTrigger.triggerWindowTicks

        val wasTrackingTarget = consecutiveTargetTicks >=
        ...
        clicker.click {
            ...
            if (Critical.enabled && entity != null) {
                ...
                val isCritical = Critical.selectionMode
