...
class ViewListener(private val cursorManager: CursorAdapter) : UltralightViewListener {
    ...
    override fun onChangeTitle(title: String) {
        println("View title has changed: $title")
    }
    ...
    override fun onChangeURL(url: String) {
        println("View url has changed: $url")
    }
    ...
    override fun onAddConsoleMessage(source: MessageSource, level: MessageLevel, message: String, lineNumber: Long,
        ...
        println("View message: [${source.name}/${level.name}] $sourceId:$lineNumber:$columnNumber: $message")
    }
    ...
    override fun onCreateChildView(openerUrl: String, targetUrl: String, isPopup: Boolean,
        ...
        println("View wants child: ")
        println("\tFrom: $openerUrl")
        println("\tTo: $targetUrl")
        println("\tIs popup: $isPopup")
        if (popupRect.isValid) {
            ...
            println("\tTarget rect: NONE")
        }
        println("Cancelling request, multi view not implemented")
