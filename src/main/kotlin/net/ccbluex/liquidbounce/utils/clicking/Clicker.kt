...
open class Clicker<T>(
    ...
    /**
     * Ticks passed since [click] last invoked [block] successfully.
     */
     ...
     *
     * Unlike [isClickTick] this cannot be overridden, so it always reflects the raw scheduler state.
     */
    fun canExecuteClickNow() = timeUntilNextClickMs(0) <= 0
