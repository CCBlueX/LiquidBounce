...
//    /**
//     * Creates a new [Angle] from [entity]'s bounding box.
...
//    fun newRaytracedRotationEntity(entity: Entity, range: Double, throughWallsRange: Double): Angle? {
...
//    fun aimAtRotation(rotation: Angle, fixVelocity: Boolean) {
