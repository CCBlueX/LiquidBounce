 ...
 */
class AttackEvent(val targetEntity: Entity?, val attackPos: Vec3) : Event()
 ...
 */
class ClickBlockEvent(val clickedBlock: BlockPos?, val WEnumFacing: EnumFacing? /* TODO: Rename this */) : Event()
 ...
 */
class RenderEntityEvent(val entity: Entity, val x: Double, val y: Double, val z: Double, val entityYaw: Float, val partialTicks: Float) : Event()
