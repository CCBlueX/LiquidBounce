...
class GuiTheAltening(private val prevGui: GuiAltManager) : GuiScreen()
{
    ...
    { // Enable keyboard repeat events
        ...
        addAltAndLoginButton = GuiButton(4, middleScreen - 100, 75, 98, 20, "Add Alt and Login")
        buttonList.add(addAltAndLoginButton)

        loginButton = GuiButton(2, middleScreen + 2, 75, 98, 20, "Just Login")
        buttonList.add(loginButton)

        // Generate button
        generateButton = GuiButton(1, middleScreen - 100, 140, "Generate")
        buttonList.add(generateButton)

        // Buy & Back buttons
        buttonList.add(GuiButton(3, middleScreen - 100, height - 54, 98, 20, "Buy"))
        buttonList.add(GuiButton(0, middleScreen + 2, height - 54, 98, 20, "Back"))

        // Token text field
        tokenField = GuiTextField(666, Fonts.font40, middleScreen - 100, 50, 200, 20)
        tokenField.isFocused = true
        tokenField.maxStringLength = Integer.MAX_VALUE

        // Api key password field
        apiKeyField = GuiPasswordField(1337, Fonts.font40, middleScreen - 100, 115, 200, 20)
    ...
    { // Draw background to screen
        ...
        Fonts.font40.drawCenteredString("\u00A77Use coupon code 'liquidbounce' for 20% off!", middleScreen, height - 65.0f, 0xffffff)
