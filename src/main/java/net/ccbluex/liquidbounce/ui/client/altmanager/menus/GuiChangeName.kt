...
class GuiChangeName(private val prevGui: GuiAltManager) : GuiScreen()
{
    ...
    override fun initGui()
    {
        ...
        buttonList.add(GuiButton(1, buttonX, quarterScreen + 96, "Change"))
    ...
    override fun actionPerformed(button: GuiButton)
    {
        when (button.id)
        {
            ...
            1 ->
            {
                ...
                mc.session = Session(nameText, prevSession.playerID, prevSession.token, prevSession.sessionType.name)
