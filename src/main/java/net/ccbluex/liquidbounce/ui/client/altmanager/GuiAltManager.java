...
public class GuiAltManager extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (searchField.getText().isEmpty() && !searchField.isFocused())
            Fonts.font40.drawStringWithShadow("§7Search...", this.searchField.xPosition + 4, 17, 0xffffff);
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        ...
        switch (button.id) {
            ...
            case 3:
                if (altsList.getSelectedSlot() != -1 && altsList.getSelectedSlot() < altsList.getSize()) {
                    randomButton.enabled = loginButton.enabled = false;
                    ...
                    final Thread thread = new Thread(() -> {
                        ...
                        randomButton.enabled = loginButton.enabled = true;
                    }, "AltLogin");
                    thread.start();
                } else
                    status = "§cSelect an account.";
