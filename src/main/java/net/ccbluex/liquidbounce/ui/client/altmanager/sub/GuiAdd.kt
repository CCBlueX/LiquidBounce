...
class GuiAdd(private val prevGui: GuiAltManager) : GuiScreen()
{
    ...
    override fun initGui()
    {
        ...
        buttonList.add(GuiButton(1, buttonX, quarterScreen + 72, "Add").also { addButton = it })
        buttonList.add(GuiButton(2, buttonX, quarterScreen + 96, "Clipboard").also { clipboardButton = it })
