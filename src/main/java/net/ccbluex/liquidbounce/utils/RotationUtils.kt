...
object RotationUtils : MinecraftInstance(), Listenable {
     ...
     * @return rotation
     */
    fun toRotation(vec: Vec3, predict: Boolean = false, fromEntity: Entity = player): Rotation {
    ...
    fun searchCenter(
        ...
        val currRotation = currentRotation ?: player.rotation
    ...
    fun getRotationDifference(entity: Entity) =
        getRotationDifference(toRotation(entity.hitBox.center, true), player.rotation)
     ...
     */
    fun isVisible(vec3: Vec3) = mc.theWorld.rayTraceBlocks(player.eyes, vec3) == null
    ...
    fun performRayTrace(blockPos: BlockPos, vec: Vec3, eyes: Vec3 = player.eyes) =
