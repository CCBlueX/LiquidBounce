...
{
    @JvmStatic
    fun findBlinkPath(thePlayer: Entity, tpX: Double, tpY: Double, tpZ: Double, xzoffset: Double, yoffset: Double): Iterable<Vector3d>
    {
    ...
    @JvmStatic
    fun findPath(thePlayer: Entity, tpX: Double, tpY: Double, tpZ: Double, offset: Double): Iterable<Vector3d>
    {
