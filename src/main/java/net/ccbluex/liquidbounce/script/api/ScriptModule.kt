...
class ScriptModule(name: String, description: String, category: ModuleCategory, private val moduleObject: JSObject) : Module(name, category, forcedDescription = description) {
