...
public abstract class MixinEnchantTableRenderer {
    ...
    private boolean hookRenderBook(SubmitNodeCollector instance, Model model, Object o, PoseStack poseStack, int i1, int i2, int i3, SpriteId spriteId, SpriteGetter spriteGetter, int i4) {
