...
public abstract class MixinLinearInterpolationHandler {
    @ModifyExpressionValue(
        method = "startInterpolating",
        at = @At(value = "FIELD", target = "Lnet/minecraft/world/entity/LinearInterpolationHandler;interpolationSteps:I", opcode = Opcodes.GETFIELD)
    )
