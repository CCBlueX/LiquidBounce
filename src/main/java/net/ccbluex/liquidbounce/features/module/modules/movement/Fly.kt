...
object Fly : Module("Fly", ModuleCategory.MOVEMENT) {
    ...
    val vanillaUpwardsTimer by FloatValue("VanillaUpwardsTimer", 1f, 0.1f..2f) { selectedFlyMode == "Vanilla" }
    val vanillaDownwardsTimer by FloatValue("VanillaDownwardsTimer", 1f, 0.1f..2f) { selectedFlyMode == "Vanilla" }
