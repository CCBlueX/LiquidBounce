...
class ReverseStep : Module()
{
    ...
    fun onUpdate(@Suppress("UNUSED_PARAMETER") event: UpdateEvent)
    {
        ...
        if (theWorld.collideBlock(bb) { it.block is BlockLiquid } || theWorld.collideBlock(AxisAlignedBB(bb.minX, bb.minY - 0.01, bb.minZ, bb.maxX, bb.maxY, bb.maxZ)) { it.block is BlockLiquid }) return
