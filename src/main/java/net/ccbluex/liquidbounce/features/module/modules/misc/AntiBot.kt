...
object AntiBot : Module()
{
    ...
    // TODO
    // fun isBotReason(theWorld: WorldClient, thePlayer: EntityPlayer, target: EntityLivingBase): String?
    // {
    // 	if (!state) return null
    //
    // 	if (!target is EntityPlayer) return null
    //
    ...
    private fun handleEntityMovement(theWorld: WorldClient, thePlayer: EntityPlayer, target: EntityPlayer, isTeleport: Boolean, newPos: Vec3, rotating: Boolean, encodedYaw: Byte, encodedPitch: Byte, onGround: Boolean)
    {
