...
object Tower : MinecraftInstance(), Listenable {
    ...
    // Timer
    val towerCustomTimerValues = BoolValue("TowerCustomTimer", false)
    val towerTimerValues = FloatValue("TowerTimer", 1.0f, 0.1f..10.0f)
    ...
    fun onMotion(event: MotionEvent) {
        ...
        if (towerCustomTimerValues.get()) mc.timer.timerSpeed = towerTimerValues.get()
