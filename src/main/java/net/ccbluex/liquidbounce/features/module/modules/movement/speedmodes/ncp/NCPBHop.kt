...
object NCPBHop : SpeedMode("NCPBHop") {
    ...
    override fun onEnable() {
        ...
        level = if (mc.theWorld.getCollidingBoundingBoxes(player, player.entityBoundingBox.offset(0.0, player.motionY, 0.0)).size > 0 || player.isCollidedVertically) 1 else 4
    }
