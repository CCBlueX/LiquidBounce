...
object Fucker : Module()
{
    ...
    fun onUpdate(@Suppress("UNUSED_PARAMETER") event: UpdateEvent)
    {
        ...
        when
        {
            ...
            actionMode.equals("Use", true) ->
            {
                ...
                if (playerController.onPlayerRightClick(thePlayer, theWorld, thePlayer.heldItem, currentPos, face, Vec3(newPos.x.toDouble(), newPos.y.toDouble(), newPos.z.toDouble())))
                {
                    if (swingValue.get()) thePlayer.swingItem()
     ...
     */
    private fun find(theWorld: World, thePlayer: Entity, targetID: Int): BlockPos?
    {
