...
class AAC3_1_6GommeFly : FlyMode("AAC3.1.6-Gomme")
{
	...
	override fun onUpdate()
	{
		...
		if (!metVoid) mc.netHandler.networkManager.sendPacketWithoutEvent(classProvider.createCPacketPlayerPosition(thePlayer.posX, posY, thePlayer.posZ, thePlayer.onGround))
