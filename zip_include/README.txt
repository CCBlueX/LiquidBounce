...
█       █   █      ██       █   █       █ █▄█   █       █       █ █ █   █    █▄▄█   █▄▄▄ 
█▄▄▄▄▄▄▄█▄▄▄█▄▄▄▄██▄█▄▄▄▄▄▄▄█▄▄▄█▄▄▄▄▄▄██▄▄▄▄▄▄▄█▄▄▄▄▄▄▄█▄▄▄▄▄▄▄█▄█  █▄▄█▄▄▄▄▄▄▄█▄▄▄▄▄▄▄█
an open source minecraft hacked client for 1.8-1.20.1.
https://liquidbounce.net/

➔ How to install on Fabric
1. Install the Fabric Mod Loader for 1.20.1 (How to: https://fabricmc.net/use/).
2. Create a folder called "mods" inside in the ".minecraft" directory.
3. Copy "liquidbounce.jar" into the mods folder.
4. REQUIRED: Install the Kotlin fabric language mod (https://www.curseforge.com/minecraft/mc-mods/fabric-language-kotlin)
5. REQUIRED: Install the Fabric API mod (https://www.curseforge.com/minecraft/mc-mods/fabric-api).
6. Launch Fabric from the Minecraft launcher.
...
Copyright © 2023 | CCBlueX | All rights reserved.
