...
object ClassProviderImpl : IClassProvider
{
	...
	override fun createCPacketResourcePackStatus(hash: String, status: ICPacketResourcePackStatus.WAction): IPacket = PacketImpl(CPacketResourcePackStatus(status.unwrap()))
	...
	override fun getPotionEnum(type: PotionType): IPotion
	{
		return PotionImpl(when (type)
		{
			...
			PotionType.DAMAGE_BOOST -> MobEffects.STRENGTH
			PotionType.FIRE_RESISTANCE -> MobEffects.FIRE_RESISTANCE
			PotionType.RESISTANCE -> MobEffects.RESISTANCE
			PotionType.ABSORPTION -> MobEffects.ABSORPTION
			PotionType.HEALTH_BOOST -> MobEffects.HEALTH_BOOST
			PotionType.WATER_BREATHING -> MobEffects.WATER_BREATHING
			PotionType.INVISIBILITY -> MobEffects.INVISIBILITY
		})
	}
