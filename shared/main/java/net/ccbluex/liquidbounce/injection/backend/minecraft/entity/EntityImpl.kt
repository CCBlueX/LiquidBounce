...
package net.ccbluex.liquidbounce.injection.backend.minecraft.entity

import net.ccbluex.liquidbounce.api.minecraft.block.material.IMaterial
import net.ccbluex.liquidbounce.api.minecraft.client.entity.*
import net.ccbluex.liquidbounce.api.minecraft.client.entity.player.IEntityPlayer
import net.ccbluex.liquidbounce.api.minecraft.util.*
import net.ccbluex.liquidbounce.injection.backend.minecraft.block.material.unwrap
import net.ccbluex.liquidbounce.injection.backend.minecraft.entity.item.EntityTNTPrimedImpl
import net.ccbluex.liquidbounce.injection.backend.minecraft.entity.monster.EntityCreeperImpl
import net.ccbluex.liquidbounce.injection.backend.minecraft.entity.player.EntityPlayerImpl
import net.ccbluex.liquidbounce.injection.backend.minecraft.entity.projectile.EntityArrowImpl
import net.ccbluex.liquidbounce.injection.backend.minecraft.entity.projectile.EntityFishHookImpl
import net.ccbluex.liquidbounce.injection.backend.minecraft.entity.projectile.EntityPotionImpl
import net.ccbluex.liquidbounce.injection.backend.minecraft.entity.projectile.EntityThrowableImpl
...
open class EntityImpl<out T : Entity>(val wrapped: T) : IEntity
{
    ...
    override fun asEntityThrowable(): IEntityThrowable = EntityThrowableImpl(wrapped as EntityThrowable)
    // </editor-fold>
