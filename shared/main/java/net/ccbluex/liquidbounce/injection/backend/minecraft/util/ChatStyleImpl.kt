...
import net.ccbluex.liquidbounce.injection.backend.minecraft.event.unwrap
import net.ccbluex.liquidbounce.injection.backend.minecraft.event.wrap
...
fun ChatStyle.wrap(): IChatStyle = ChatStyleImpl(this)
