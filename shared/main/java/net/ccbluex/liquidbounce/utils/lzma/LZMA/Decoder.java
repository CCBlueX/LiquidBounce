...
import net.ccbluex.liquidbounce.utils.lzma.LZ.OutWindow;
import net.ccbluex.liquidbounce.utils.lzma.RangeCoder.BitTreeDecoder;
import net.ccbluex.liquidbounce.utils.lzma.RangeCoder.RangeDecoder;
...
public class Decoder {
    ...
    public static byte[] decode(InputStream inputStream) throws IOException {
        ...
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream(Math.toIntExact(outSize));
    ...
    public boolean Code(InputStream inStream, java.io.OutputStream outStream,
