...
fun String.withBrackets(textColorCodes: String = "\u00A79\u00A7l", bracketColorCodes: String = "\u00A78") = "$bracketColorCodes[$textColorCodes$this$bracketColorCodes]\u00A7r"
...
fun String.withPrefix(prefix: String, prefixColorCodes: String = "\u00A79\u00A7l", bracketColorCodes: String = "\u00A78", textColorCodes: String = "\u00A73") = "${prefix.withBrackets(prefixColorCodes, bracketColorCodes)} $textColorCodes$this"
