...
@ModuleInfo(name = "KillInsults", description = "Sends annoying messages when you kill someone. (a.k.a. AutoSay)", category = ModuleCategory.MISC)
class KillInsults : Module()
{
	/**
	 * Options
	 */
