...
class PositionCheck : BotCheck("position.position")
{
	...
	override fun onRender3D(event: Render3DEvent)
	{
		...
		val dir = WMathHelper.toRadians(lastServerYaw + (serverLocation.rotation.yaw - lastServerYaw) * partialTicks - 180.0F)
		...
		val bb = classProvider.createAxisAlignedBB(-width - renderPosX, -renderPosY, -width - renderPosZ, width - renderPosX, height - renderPosY, width - renderPosZ)
