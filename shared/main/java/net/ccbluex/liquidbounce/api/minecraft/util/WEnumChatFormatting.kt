...
enum class WEnumChatFormatting(val formattingName: String, val formattingCodeIn: Char, val fancyStylingIn: Boolean, val colorIndex: Int)
{
	...
	DARK_GRAY("DARK_GRAY", '8', 8), BLUE("BLUE", '9', 9), GREEN("GREEN", 'a', 10), AQUA("AQUA", 'b', 11), RED("RED", 'c', 12), LIGHT_PURPLE("LIGHT_PURPLE", 'd', 13), YELLOW("YELLOW", 'e', 14), WHITE("WHITE", 'f', 15), OBFUSCATED(
	"OBFUSCATED", 'k', true
),
	BOLD("BOLD", 'l', true), STRIKETHROUGH("STRIKETHROUGH", 'm', true), UNDERLINE("UNDERLINE", 'n', true), ITALIC("ITALIC", 'o', true), RESET("RESET", 'r', -1);
	...
	override fun toString(): String = "\u00A7$formattingCodeIn"
}
